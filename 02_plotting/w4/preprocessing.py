...
filepath = '../data/calidad_aire_2011_2018.csv'
...
cols_original = list(pd.read_csv('../data/calidad_aire_2011_2018.csv', nrows=1).
                     columns.values)
...
for chunk in pd.read_csv(filepath, usecols=cols_import, names=cols_names,header=0, chunksize=chunksize):
    chunk = chunk[(chunk['variable'] == 'PM10') | (chunk['variable'] == 'O3')]
